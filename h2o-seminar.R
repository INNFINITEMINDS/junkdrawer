...
# define metalearner and subsets
...
fit <- subsemble(x=x, y=y, newx=newx, family=binomial(),
                 ...
                 subsets=subsets)
## subsemble() has (parallel = "multicore") option
...
metalearner <- "h2o.deeplearning.wrapper"  ## tree-based methods are not very
                                           ## good for meta-learning
